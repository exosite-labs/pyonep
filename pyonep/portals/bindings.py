...
class Bindings(Portals):
    ...
    def login_to_portal(cls,
        ...
        """
            ...
            Sets up the Bindings object with all the member variables
            it needs to make future api calls. It basically just calls 
            Bindings.get_portal_by_name(), but instead of returning a 
            Portals object, it returns a Bindings() object.

            This is a convenience function that can be called at the 
            time of instantiation.

            Instantiate the Bindings object with user/password authentication
            then call this function. The resultant object will be a Bindings
