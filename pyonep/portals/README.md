...
>>> from pyonep.portals import Portals
>>> token, P = Portals.login_to_portal()
...
>>> P
<pyonep.portals.bindings.Portals object at 0x10356d278>
>>> P.portal_cik()
'4bc278b*********************************'
>>> all_devices = P.get_all_devices_in_portal()
>>> my_permissions = P.get_user_permission_from_email('willcharlton@exosite.com')
>>> my_permissions
...
>>> P.get_user_id_from_email(
┌────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ P.get_user_id_from_email: (self, email)                                                                │
